...
const DoctorSchema = new mongoose.Schema({
  ...
  password: {
    type: String,
    required: [true, "Please provide Doctor's Password"],
    trim: true,
  },
  age: {
    type: String,
  ...
  speciality: {
    type: String,
    required: [true, "Please provide Doctor's Speciality"],
    trim: true,
  },
  venue: {
    type: String,
...
DoctorSchema.methods.comparePassword = async function (doctorPassword) {
  return await bcrypt.compare(doctorPassword, this.password);
};
